...
class StaticOptionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //Custom
         set_static_option('website_banner_image', null);
         set_static_option('website_banner_title', null);
         set_static_option('website_banner_description', null);
         set_static_option('website_banner_btn_url', null);
